...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                <li class="active-link">Tasks</li> <a href="#" class="btnAddCust btn btn-success"
                    ><em class="fa fa-plus">&nbsp;</em> Create Tasks</a>
            </ol>
        </div><!--/.row-->
                ...
                <table id="example1" class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a href="task-details.php" class="btn btn-info"><em class="fa fa-eye">&nbsp;</em>
                                    details</a></td>
                        </tr>
                        <tr>
                            <td>TSCN-567-21</td>
